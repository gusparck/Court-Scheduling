...
public class Controle
{
    ...
    public void setQuadras(Quadras quadra) { quadras.add(quadra); }
            ...
            if (!clientes.isEmpty())
            {
                for (Clientes x : clientes) {
                    if (x.getNome().equals(cliente.getNome()) ||
                            (x.getEmail().equals(cliente.getEmail())) ||
    ...
    public void reservarQuadra(Quadras quadra, Clientes cliente, LocalDateTime hoario){
        quadra.getReservas().add(hoario);
        Reservas reserva = new Reservas(cliente,quadra,hoario);
    ...
    public void cancelarReserva(Clientes cliente, Reservas reserva){
        ...
        quadra.getReservas().remove(horario);
    }
